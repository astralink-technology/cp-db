...
DECLARE fname text;
BEGIN
FOR fname IN SELECT oid::regprocedure FROM pg_catalog.pg_proc WHERE proname = 'get_glucose_readings' LOOP
  EXECUTE 'DROP FUNCTION ' || fname;
END loop;
RAISE INFO 'FUNCTION % DROPPED', fname;
END$$;
-- Start function
CREATE FUNCTION get_glucose_readings(
    ...
    CREATE TEMP TABLE eyecare_init AS
      SELECT
        ...
        , ey.name as entity_name
          ...
          (e.event_type_id = '20015') AND -- Get Glucose Readings
